(function($) {
	 ...
	 * @since 1.6.1
	 */
	FLBuilderLogoCarousel = function( settings ){

		// set params
		this.settings 		     = settings.settings;
		this.transitionType	     = settings.transition;
		this.nodeClass           = '.fl-node-' + settings.id;
		this.wrapperClass        = this.nodeClass + ' .fl-logo-carousel-wrapper';
		this.postClass           = this.nodeClass + ' .fl-logo-carousel-post';
	...
	FLBuilderLogoCarousel.prototype = {
		settings                : {},
		nodeClass               : '',
		wrapperClass            : '',
		postClass               : '',
		 ...
		 */
 		...
 		{
 			var $wrapper = $( this.nodeClass + ' .fl-logo-carousel' );
 				$width 	 = $wrapper.width();
			...
			var newSettings,
				settings = {
				    ...
				    onSliderLoad: function() { 
						$( this.wrapperClass ).addClass( 'fl-logo-carousel-loaded' ); 
					}.bind( this ),
