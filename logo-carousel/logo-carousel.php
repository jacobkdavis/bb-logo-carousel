...
/**
 * @class FLLogoCarouselModule
 */
class FLLogoCarouselModule extends FLBuilderModule {
	...
	public function render_post_class( $layout ) {
		...
		$classes      = array( 'fl-logo-carousel-post' );

		if ( 'gallery' === $layout && $no_thumbnail ) {
			$classes[] = 'fl-post-no-thumb';
		}

		post_class( apply_filters( 'fl_builder_logo_carousel_classes', $classes, $settings ) );
	}
 ...
 */
FLBuilder::register_module('FLLogoCarouselModule', array(
	'general' => array(
...
// 					),
			...
			'photos' => array(
				'title'  => __( 'Photo Settings', 'fl-builder' ),
				'fields' => array(
					'grayscale' => array(
						'type'    => 'select',
						'label'   => __( 'Grayscale', 'fl-builder' ),
						'default' => 'no',
						'options' => array(
							'no'  => __( 'No', 'fl-builder' ),
					...
					'photo_max_height' => array(
						'type'     => 'unit',
						'label'    => __( 'Photo Max Height', 'fl-builder' ),
						'default'  => '140',
						'sanitize' => 'absint',
						'units'    => array( 'px' ),
						'slider'   => true,
				...
				'fields' => array(
					'title_color'       => array(
						...
						'preview'     => array(
							...
							'rules' => array(
								array(
									'selector' => '{node} .fl-logo-carousel-title a',
									'property' => 'color',
								),
							),
						),
					...
					'title_typography'  => array(
						...
						'preview'    => array(
							'type'     => 'css',
							'selector' => '{node} .fl-logo-carousel-title',
						),
					),
				),
			),
				...
				'fields' => array(
					'meta_color'            => array(
						...
						'preview'     => array(
							...
							'rules' => array(
								array(
									'selector' => '{node} .fl-logo-carousel-meta',
									'property' => 'color',
								),
							),
						),
					...
					'meta_link_color'       => array(
						...
						'preview'     => array(
							...
							'rules' => array(
								array(
									'selector' => '{node} .fl-logo-carousel-meta a',
									'property' => 'color',
								),
							),
						),
				...
				'fields' => array(
					'content_color'            => array(
						...
						'preview'     => array(
							...
							'rules' => array(
								array(
									'selector' => '{node} .fl-logo-carousel-content',
									'property' => 'color',
								),
							),
						),
					...
					'content_link_color'       => array(
						...
						'preview'     => array(
							...
							'rules' => array(
								array(
									'selector' => '{node} .fl-logo-carousel-content a:not(.fl-logo-carousel-more)',
									'property' => 'color',
								),
							),
						),
					...
					'content_typography'       => array(
						...
						'preview'    => array(
							'type'     => 'css',
							'selector' => '{node} .fl-logo-carousel-content :not(.fl-logo-carousel-more)',
						),
					),
				),
			),
				...
				'fields' => array(
					'more_link_color'       => array(
						...
						'preview'     => array(
							...
							'rules' => array(
								array(
									'selector' => '{node} .fl-logo-carousel-more',
									'property' => 'color',
								),
							),
						),
			...
			'nav_arrow_color' => array(
				...
				'fields' => array(
					...
					'arrows_text_color' => array(
						...
						'preview'     => array(
							'type'     => 'css',
							'selector' => '.fl-logo-carousel-navigation path',
							'property' => 'fill',
						),
					),
				),
